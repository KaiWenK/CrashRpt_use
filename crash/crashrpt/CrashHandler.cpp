...
#ifndef CRASHRPT_LIB
#ifdef _DEBUG
    sCrashRptModule.Format(_T("CrashRptd.dll"));
    pszCrashRptModule = sCrashRptModule.GetBuffer(0);
#else
    sCrashRptModule.Format(_T("CrashRpt.dll"));
    pszCrashRptModule = sCrashRptModule.GetBuffer(0);
#endif //_DEBUG
#else //!CRASHRPT_LIB
...
#ifdef _DEBUG
    sCrashSenderName.Format(_T("CrashSenderd.exe"));
#else
    sCrashSenderName.Format(_T("CrashSender.exe"));
#endif //_DEBUG
